...
import 'package:flutter_core_null_safety_2/core/utils/mixins/action_state_mixin.dart';
import 'package:flutter_core_null_safety_2/core/utils/mixins/action_state_mixin.dart';
...
class _CoreUpgradeBlocBuilderState<C extends Cubit<S>, S extends CoreState> extends State<CoreUpgradeBlocBuilder<C, S>>
  ...
  Widget build(BuildContext context) => BlocConsumer<C, S>(
        ...
        buildWhen: (prevState, currentState) {
          ...
          return makeBuildWhenListener(prevState, currentState, (ctx, state) {
            _widget = null;
            return widget.buildWhen?.call(ctx! as S, state! as S) ?? false;
          }, () {
        ...
        listenWhen: (prevState, state) {
          _prevState = prevState;
          return widget.listenWhen?.call(prevState, state) ?? false;
        },
        listener: (context, state) {
          handleErrorListener(
            ...
            redirectLoginListener: widget.redirectLoginListener?.call(),
            notInternetConnectionListener: widget.noInternerConnectionListener,
            applicationExeptionListener: widget.applicationExeptionListener,
          );
