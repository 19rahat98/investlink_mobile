...
import 'package:investlink_mobile/features/counter/cubit/counter_cubit.dart';
import 'package:investlink_mobile/features/counter/view/details_screen.dart';
      ...
      floatingActionButton: Column(
        ...
        children: [
          FloatingActionButton(
            onPressed: () {
              context.read<LocalLanguageCubit>().changeLocalApp(Languages.languages[2]);
          ...
          FloatingActionButton(
            onPressed: () {
              context.read<LocalLanguageCubit>().changeLocalApp(Languages.languages[1]);
